...
param main_burnout{MaintenanceSeverity}; # weights to indicating staff's exhaustion due to work on task with given severity  
param burnout_coef; # bearable level of staff's exhaustion  
