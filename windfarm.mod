...
# xp points required for 1 maintenance task should be provided by the required staff for the given task
# e.g. blades requires 36 xp, and 3 mechanics and 4 storage workers, so the 36 xp should be provided/
...
for{st in StaffTypes} printf "\t%s\t",st;
printf "\n";
